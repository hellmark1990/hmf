 ...
 * @ORM\Entity(repositoryClass="ProfileBundle\Entity\PropositionRepository")
 */
class Proposition
{
    /**
     ...
     * @ORM\JoinTable(name="proposition_media",
     *      joinColumns={@ORM\JoinColumn(name="proposition_id", referencedColumnName="id")},
